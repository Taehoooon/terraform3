...
sed -i 's/password_here/!myself153/g' /var/www/html/wp-config.php
sed -i 's/localhost/mydb.cxoldwqckoj4.ap-northeast-2.rds.amazonaws.com/g' /var/www/html/wp-config.php
